...
describe('Pizzas Actions', () => {
  ...
  describe('LoadPizzas Actions', () => {
    ...
    describe('LoadPizzasSuccess', () => {
      it('should create an action', () => {
        const payload = [
          { "name": "Blazin' Inferno", "toppings": [{ "id": 10, "name": "pepperoni" }], "id": 1 },
          { "name": "Seaside Surfin'", "toppings": [{"id": 6, "name": "mushroom" }], "id": 2 }
        ];
  ...
  describe('CreatePizza Actions', () => {
    describe('CreatePizza', () => {
      it('should create an action', () => {
        const payload = { "name": "Seaside Surfin'", "toppings": [{ "id": 6, "name": "mushroom" }], "id": 2 };
